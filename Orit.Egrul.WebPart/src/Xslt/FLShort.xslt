...
xmlns:a="http://ws.unisoft/EGRNXX/ResponseKSIP">
	<xsl:output method="html" version="1.0" encoding="UTF-8" indent="yes"/>

	<xsl:template match="/ДокументОтвет1">
		<xsl:apply-templates select="a:СвИП"/>
	</xsl:template>
<xsl:template match="a:СвИП">
		<div class="docHeader">
			<h2>Из Единого государственного реестра физических лиц
		...
		<div class="MainInfo  infoblock">
			<table width="100%">
				...
				<tr>
					...
					<td>
						<xsl:value-of select="@ДатаОГРНИП"/>
					</td>
				</tr>
				<tr>
					<td>ИНН</td>
					...
					<tr>
						...
						<td>
							<xsl:value-of select="a:СвСтатус/@НаимСтатус"/>
						</td>
					</tr>
			</table>
		</div>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="FLShort.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
